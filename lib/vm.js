...
VM.prototype = {
  constructor: VM,
  render: function (content, realPath) {
    var ENV = {};
    ...
    if (isScreen && fs.existsSync(realPath) && !fs.existsSync(dataFilePath)) {
    ...
    this.context = merge.recursive(true, this.context, this.setUtils(), ENV);
